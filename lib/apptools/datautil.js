...
const exfieldtypeList = ['code', 'script', 'layout', 'container', 'template', 'dialog', 'reportmakeup', 'markdown'];
const specfieldtypeList = ['smartbutton', 'smartbutton2', 'link'];
...
function isSpecfieldtype(type) {
  return specfieldtypeList.includes(type);
}
