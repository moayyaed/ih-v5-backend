...
async function getDevpropsSubTree(nodeid) {
  console.log('getDevpropsSubTree nodeid='+nodeid)
  ...
  if (docs && docs[0]) {
    ...
    console.log('getDevpropsSubTree hrec='+util.inspect(hrec));
