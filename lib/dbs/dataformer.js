    ...
    if (id == 'formPluginCommon') {
      ...
      if (nodeid.startsWith('modbus')) {
        data.p2 = [
          ...
          { prop: 'ip', title: 'Modbus IP', type: 'input', hide: '!data.p2.transport.id || (data.p2.transport.id == "rtu")' },
          { prop: 'port', title: 'Port', type: 'input', hide: '!data.p2.transport.id || (data.p2.transport.id == "rtu")' },
          {
            prop: 'serialport',
            title: 'Serial Port',
            type: 'input',
