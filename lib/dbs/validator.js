    ...
    if (doc) {
      ...
      if (valObj && valObj.main) {
        // Object.keys(doc).forEach(prop => {
          ...
          if (valObj.main[prop]) {
            const errTxt = await checkProp(valObj.main[prop], prop, doc, table);
