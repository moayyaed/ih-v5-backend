...
const specForms = ['formSceneScript', 'formDbagentCommon'];
...
function getPluginFormName(id) {
  const plspec = ['formDbagentCommon', 'formPluginCommon', 'channelview', 'channellink', 'channelfolder', 'formPluginChannelsTable', 'formPluginPublish'];
