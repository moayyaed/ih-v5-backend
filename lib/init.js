...
module.exports = async function(appdir) {
  ...
  await appconfig.prepareKeys();

  // const filename = appconfig.get('sysbasepath') + '/keys/publicAuth.pem';
  appcrypto.start(appconfig.get('sysbasepath') + '/keys/publicAuth.pem', appconfig.get('hwid'));
