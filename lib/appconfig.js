...
module.exports = {
  ...
  getApihandlerFilename(id) {
    return path.join(config.apihandlerpath, id + '.js');
  },
...
function checkAndMakeProjectFolders(xconfig) {
  ...
  xconfig.apihandlerpath = `${xconfig.projectpath}/apihandlers`;
  fut.checkAndMakeFolder(xconfig.apihandlerpath);
