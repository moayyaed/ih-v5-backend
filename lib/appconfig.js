...
module.exports = {
  ...
  */
  ...
  // Возвращает список файлов-лицензий
  getLicenseList() {

    return fut.readFolderSync(config.mainbasepath, { ext: 'lih' });    
  ...
  getConfName() {
    switch (this.get('conf')) {
      case 2: return 'intrascada_v5';
      default: return 'intrahouse_v5';
    }
  },
...
function checkAndMakeProjectFolders(xconfig) {
  ...
  */
  ...
  xconfig.deviceloglines = projectJson.deviceloglines || 100;
}
