...
class Sceno {
  ...
  */
  ...
  setTimerState(timername, state, tsobj, interval, callback) {
    ...
    console.log('setTimerState timername='+timername+' state='+state+' this.timerSet='+util.inspect(this.timerSet))
  }
  ...
  hasPendingTimers() {
    console.log('hasPendingTimers his.timerSet='+util.inspect(this.timerSet))
