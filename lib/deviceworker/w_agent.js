...
module.exports = {
  ...
  runUserHandler(dobj, handlerObj, prop, arg3, arg4) {
    ...
    if (!fn) {
      console.log('ERROR: WORKER.runUserHandler  No fn in '+util.inspect(handlerObj))
      return;
    }
    ...
    console.log('runUserHandler ' + hanid);
    ...
    try {
      ...
      // Нужно у себя блокировать!!
      this.setHandlerBlk(dobj.type, prop, 1);
      if (currentScript) {
