 ...
 *  - запускает движок w_deviceengine
 */
...
const { devSet, typeMap, glSet, sceneSet, boot } = workerData; // boot - флаг, что worker запущен впервые
wCore.boot = boot;
...
// Запуск движка устройств, он выполняет обработчики и сценарии
