...
module.exports = function (vtype) {
  switch (vtype) {
    ...
    case 'N': return {
      'N_LoLo': {theval:0, message:'OK',level:3, delay:0,toClose:'stop' },
      'N_Lo': {theval:0, message:'Alarm!',level:1, delay:0,toClose:'stop' },
      'N_0': {theval:0, message:'OK',level:0, delay:0 },
      'N_Hi': {theval:0, message:'Alarm!',level:2, delay:0,toClose:'stop' },
