 ...
 *  - Слушает holder:
 *       - обработка массива изменения данных устройств(запускается событием поступлени данных)
 *  - Слушает dm:
 *       - изменяет devSet, devMap при изменении:
 *           - добавление, удаление, изменение устройства
 *           - изменение типа => влечет за собой изменение устройств
 */
