...
class Devicemate {
  ...
  async updateType(doc) {
    ...
    if (propsAddAlerts.length)  this.engine.emitUpdateTypeAlerts('add', typeId, propsAddAlerts);
    if (propsClearAlerts.length)  this.engine.emitUpdateTypeAlerts('remove', typeId, propsClearAlerts);
