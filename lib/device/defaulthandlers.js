...
module.exports = {
  ...
  def_rw_N: function(device, prop, value, chstatus) {
  ...
  def_rw_B: function(device, prop, value, chstatus) {
    return value == 0 || value == 1 ? Number(value) : { error: 'Допустимые значения 1/0. Получено ' + value };
  },

  def_rw_S: function(device, prop, value, chstatus) {
  ...
  def_rw: function(device, prop, value, chstatus) {
    return value;
  },

  def_par: function(device, prop, value, chstatus) {
    return value;
  },

  def_evnt: function(device, prop, value, chstatus) {
    return value;
  },
