...
module.exports = {
  format_def: function (device, prop, val) {
    return isNaN(val) ? val: val.toFixed(device.getDig(prop));
  },
  ...
  def_OnChange: function(device, trigger) {

  },

  def_OnInterval: function( device) {

  },

  def_OnSchedule: function( device) {
