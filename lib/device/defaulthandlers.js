...
module.exports = {
  ...
  format_def_N: function (device, prop, val) {
    return val.toFixed(device.getDig(prop))+device.getMu(prop);
  },
  ...
  */
  ...
  def_OnChange: function(device, triggers, global) {

  },

  def_OnInterval: function( device, triggers, global) {

  },

  def_OnSchedule: function( device, triggers, global) {
