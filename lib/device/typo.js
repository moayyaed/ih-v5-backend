...
class Typo {
  ...
  updateFromMain(typeObj) {
    this.item = hut.clone(typeObj.item);
    this.props = hut.clone(typeObj.props);
    this.proparr = hut.clone(typeObj.proparr);
    this.commands = hut.clone(typeObj.commands);
    this.calc = hut.clone(typeObj.calc);
    this.onHandlers = hut.clone(typeObj.onHandlers);
  }
