...
async function formDeviceLogOnSub(event, key, logobj, contexId) {
  ...
  switch (event) {
    ...
    case 'dialog':
      ...
      return formChangedDeviceLog(logobj, uppobj.data, contexId);
    default:
  }

}

function formChangedDeviceLog(logobj, uppobj, contexId) {
  ...
  if (contexId && uppobj.devicelog.__device == contexId) {
