...
async function formContainerSubConditionWithContext(mes, holder) {
  ...
  console.log('WARN: formContainerSubConditionWithContext '+util.inspect(res))
  return res;
}
