...
async function importDocs({format, data, content, nodeid}, holder) {

  if (importmethods[format] && importmethods[format][content]) {
    return importmethods[format][content]({data, nodeid}, holder);
  }
