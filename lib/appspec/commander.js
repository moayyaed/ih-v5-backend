  ...
  switch (mes.command) {
    ...
    case 'layout':
      ...
      if (datautil.existsListItem('dialogList', mes.id)) {
        ...
        /*
        if (mes.layoutId) contextId += 'layout:'+mes.layoutId+'__';
        if (mes.containerId) contextId += 'container:'+mes.containerId+'__';
        if (mes.elementId) contextId += 'element:'+mes.elementId;
        */
