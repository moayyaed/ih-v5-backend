...
describe('utils/dbdatautil', () => {
  describe('insertToDataArray', () => {
    ...
    it('insert one item array into array', () => {
      ...
      dbdatautil.insertToDataArray(dataArr, data2, 2, 2);
    ...
    it('insert one item array - to 2-items array', () => {
      const dataArr = [ [1605013603557, 22, null ],  [1605013613601, 24, null]];
      const data2 = ["DN2,value,1605013608579, 23"];
    ...
    it('insert 2-item array - to 2-items array', () => {
      const dataArr = [ [1605013603557, 22, null ],  [1605013613601, 24, null]];
      const data2 = ["DN2,value,1605013608579, 23",  "DN2,value,1605013618718, 25"];
