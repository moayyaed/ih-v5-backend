  ...
  start(unitDocs) {
    ...
    unitDocs.forEach(uobj => {
      ...
      try {
        ...
        // Имя системного устройства - индикатора плагина
        this.unitSet[unitId].dn = deviceutil.getUnitIndicatorId(unitId);
        ...
        if (this.unitSet[unitId].active) {
          ...
          this.logUnit(unitId, 'IH: Plugin '+unitId+' not active', 1);
        }
      } catch (e) {
