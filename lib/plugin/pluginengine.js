...
class Pluginengine {
  ...
  async createUnit(doc) {
    ...
    uobj.chano = new Unitchano(doc, unitChannels, this.getChannelOptionsFromManifest(manifest.data));

    return uobj;
  }

  getChannelOptionsFromManifest(manifestData) {
   return manifestData ? {"smart": manifestData.smart || 0} : {};
  }
