...
async function getVirttable(tableName, dataFromTable, table, cNodeid, item, holder, id) {
  return isVirttable(tableName) ? virttables[tableName](dataFromTable, table, cNodeid, item, holder, id) : [];
}
