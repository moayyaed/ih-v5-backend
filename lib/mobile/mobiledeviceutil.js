...
async function checkAddMobileDeviceDoc(id, dm) {
...
async function tryAddMobileDeviceDoc(id, dm) {
  ...
  const { color0, image0, color1, image1, cl, typev4 } = mobiletypeDoc;
  if (!cl || cl == '-') throw { message };
