    ...
    return new Proxy(
      {},
      {
        ...
        get: (target, prop, receiver) => {
          ...
          if (prop == 'tags') return dobj.tags;
          if (prop == 'location') return dobj.location;
          if (prop == 'locationStr') return dobj.locationStr;
          ...
          if (dobj.hasCommand(prop)) {
            if (dobj.isCommand(prop)) {
              ...
              return function() {
                dobj.doCommand(prop, agent.getWorkingScript());
              };
            }
            ...
            return function(...args) {
              args.push(agent.getWorkingScript());
