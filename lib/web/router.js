...
async function processApi(body, token) {
  ...
  switch (method) {
    ...
    case 'getmeta':
      if (!type) throw { error: 'ERRPOST', message: 'Type not defined for method:getmeta!' };
      if (!id) throw { error: 'ERRPOST', message: 'Id not defined for method:ggetmeta!' };
