...
module.exports = function(holder) {
  return async (req, res) => {
    ...
    try {
      ...
      if (!req.files.param) throw { error: 'BADREQ', message: 'Expected files.param for upload!' };
      const targetFolder = getTargetFolder(req.files.param);
      const parentid = req.files.parentid || '';
