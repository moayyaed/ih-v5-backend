...
module.exports = function(holder) {
  return async (req, res) => {
    ...
    try {
      ...
      console.log('WARN: UPLOAD files: ' + util.inspect(files, null, 5));
    ...
    async function extractFromZip(file) {
      console.log('WARN: extractFromZip ' + util.inspect(file, null, 4));
      try {
      ...
      console.log('WARN: writeFile  zipfile=' + zipfile+' file.data'+util.inspect(file.data, null, 4));
