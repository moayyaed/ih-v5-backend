...
module.exports = async function(holder) {
  ...
  express_app.use((req, res, next) => {
    ...
    const str = "default-src * data: blob: 'unsafe-inline' 'unsafe-eval'; script-src * data: blob: 'unsafe-inline' 'unsafe-eval'; connect-src * data: blob: 'unsafe-inline'; img-src * data: blob: data: blob: 'unsafe-inline'; frame-src * data: blob:  style-src * data: blob: 'unsafe-inline'; manifest-src * data: blob: 'unsafe-inline'; font-src * data: blob: 'unsafe-inline'";
